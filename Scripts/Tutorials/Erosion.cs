...
public class Erosion : MonoBehaviour
{
    ...
    public static int full_width = 200;
    public static int dim = 512;
    public static double cell_width;
    public static double cell_area;

    // Water-related constants
    public static double rain_rate_setting = 0.0008d;
    public static double evaporation_rate = 0.0005d;

    public static double rain_rate;

    // Slope constants
    public static double min_height_delta = 0.05d;
    public static double repose_slope = 0.03d;
    public static double gravity = 30.0d;
    public static double gradient_sigma = 0.5d;

    // Sediment constants
    public static double sediment_capacity_constant = 50.0d;//50.0d;
    public static double dissolving_rate = 0.25d;
    public static double deposition_rate = 0.001d;
    ...
    public static int traceLevel = 15;
    ...
    private void OnValidate()
    {
        ...
        cell_width = (double)((double)full_width /(double) dim);
        cell_area = cell_width * cell_width;
        rain_rate = rain_rate_setting * cell_area;
        iterations = 0;
    ...
    private static double[,] ApplySlippage(double[,] terrain, double repose_slope, double cell_width, int mapSize)
    {
    ...
    private static double[,] gaussianBlur(double[,] a, double sigma, int mapSize)
    {
        double[,] result = new double[mapSize, mapSize];
        //TODO
    ...
    private static double Fns(int i, double x)
    {
        if (i == -1)
        {
            return -x;
    ...
    private static double[,] Displace2(double[,] a, Complex[,] delta, int mapSize)
    {
        double[,] result = new double[mapSize, mapSize];
    ...
    private static double[,] Displace(double [,] a, Complex[,] delta, int mapSize, string tag)
    {
        double[,] result = new double[mapSize, mapSize];
    ...
    private static void PrintTabDouble(double[,] tab, string name, int lvl, int tabSize)
    {
    ...
    private static void PrintTabFloat(float[,] tab, string name, int lvl, int tabSize)
    {
    ...
    private static void PrintTabInt(int[,] tab, string name)
    {
        /*Debug.Log(name);
    ...
    private static void PrintTabComplex(Complex[,] tab, string name, int lvl, int tabSize)
    {
    ...
    private static void PrintTabVec(UnityEngine.Vector2[,] tab, string name)
    {
        /*Debug.Log(name);
        for (int x = 0; x < 3; x++)
        {
    ...
    private static UnityEngine.Vector2 simpleGradient(int mapHeight, double[,] terrain, int y, int x)
    {
    ...
    private static Complex simpleGradientCWithoutNormalization(int mapHeight, double[,] terrain, int y, int x)
    {
    ...
    private static Complex simpleGradientC(int mapHeight, double[,] terrain, int y, int x)
    {
        // wrap world
    ...
    private static UnityEngine.Vector2[,] getSimpleGradient(int mapWidth, int mapHeight, double[,] noiseMap)
    {
    ...
    private static Complex[,] getSimpleGradientC(int mapWidth, int mapHeight, double[,] noiseMap)
    {
    ...
    private static Complex[,] getSimpleGradientCWithoutNormalization(int mapWidth, int mapHeight, double[,] noiseMap)
    {
        Complex[,] gradient = new Complex[mapWidth, mapHeight];
        for (int y = 0; y < mapWidth; y++)
        {
    ...
    public static double[,] sample(double[,] a, UnityEngine.Vector2[,] offset,int mapSize)
    {
